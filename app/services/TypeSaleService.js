...
export class TypeSaleService {
    constructor() {
        this.url = `${API}/TypeSale.php`;
    }

    async getTypeSale(page) {
...
export class Number{
    constructor() {
        this.url = `${API}/ConsultNumberTypeSale.php`;
    }
