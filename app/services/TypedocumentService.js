...
export class TypeDocumentService {
    constructor() {
        this.url = `${API}/Typedocument.php`;
    }

    async getTypeDocument(page) {
    ...
    async updateTypeDocument(body, id) {
...
export class Number{
    constructor() {
        this.url = `${API}/ConsultNumberTypeDocument.php`;
    }
