...
$consulta ="SELECT cliente.cliente,ventas.fecha_realizacion, produto.nombre_produc, detalleventa.cantidad, detalleventa.total
FROM detalleventa
INNER JOIN ventas ON detalleventa.id_venta = ventas.id_venta
INNER JOIN cliente ON ventas.id_cliente = cliente.id_cliente
INNER JOIN produto ON detalleventa.id_producto = produto.id_producto";
...
$pdf->Cell(0,5, 'Ventas',0,0,'C');
$pdf->Cell(80);
$pdf->Ln(10);
$pdf->SetFillColor(255, 255, 255);

$pdf-> cell(30,10, 'Cliente', 0,0, 'B', 1);
$pdf-> cell(30,10, 'Fecha', 0,0, 'B', 1);
$pdf-> cell(65,10, 'Producto', 0,0, 'c', 1);
$pdf-> cell(40,10, 'Cantidad', 0,0, 'c', 1);
$pdf-> cell(35 ,10, 'Total', 0,1, 'c', 1);
$pdf->SetDrawColor(50,15,263);
$pdf->SetLineWidth(0.5);
$pdf->Line(10,57,200,57);

while($row = $resultado->fetch_assoc()){
    $pdf-> cell(30,10, $row['cliente'], 0,0, 'c', 0);
    $pdf-> cell(30,10, $row['fecha_realizacion'], 0,0, 'c', 0);
    $pdf-> cell(65,10, $row['nombre_produc'], 0,0, 'c', 0);
    $pdf-> cell(40,10, $row['cantidad'], 0,0, 'c', 0);
    $pdf-> cell(35,10, $row['total'], 0,1, 'c', 0);
}
