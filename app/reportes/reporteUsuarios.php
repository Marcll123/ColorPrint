...
$consulta = "SELECT usuarios.nombre, usuarios.apellido, usuarios.correo, roles.roles
FROM usuarios
...
$pdf->Cell(0,5, 'Usuarios',0,0,'C');
$pdf->Cell(80);
$pdf->Ln(10);
$pdf->SetFillColor(255, 255, 255);

$pdf-> cell(55,10, 'Nombre', 0,0, 'B', 1);
$pdf-> cell(55,10, 'Apellido', 0,0, 'B', 1);
$pdf-> cell(50,10, 'Correo', 0,0, 'c', 1);
$pdf-> cell(40,10, 'Rol', 0,0, 'c', 1);
...
while($row = $resultado->fetch_assoc()){
    $pdf-> cell(55,10, $row['nombre'], 0,0, 'c', 0);
    $pdf-> cell(55,10, $row['apellido'], 0,0, 'c', 0);
    $pdf-> cell(50,10, $row['correo'], 0,0, 'c', 0);
    $pdf-> cell(30,10, $row['roles'], 0,1, 'c', 0);
}
